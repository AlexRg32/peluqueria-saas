...
![Marketplace](./assets/showcase/screenshot-marketplace.png)

### 2. Búsqueda de Negocios

Sistema de filtrado por ciudad y servicios para encontrar el salón ideal.
![Búsqueda](./assets/showcase/screenshot-search.png)
...
![Perfil de Negocio](./assets/showcase/screenshot-business-profile.png)
...
![Dashboard Admin](./assets/showcase/screenshot-admin-dashboard.png)
...
![Mis Citas](./assets/showcase/screenshot-client-appointments.png)
