...
- If `CURRENT_BRANCH` is `main` → **ABORT**. Tell the user: _"You are on the integration branch (`main`). The `pr` workflow is meant to push a feature branch and create a PR. Please switch to a feature branch first."_
