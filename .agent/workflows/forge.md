...
- **Skill Map**:
  ...
  - Phase 2 → `software-architecture`, `api-patterns`, `database-design`, `frontend-dev-guidelines`, `backend-dev-guidelines`, `stitch-designs`, `landing-page-anatomy`, `premium-animations`, `advanced-tailwind-styling`
