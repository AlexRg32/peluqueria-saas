...
Detailed metrics guide: [references/metrics-guide.md](https://github.com/render-oss/skills/blob/main/skills/render-monitor/references/metrics-guide.md)
...
- **Metrics guide:** [references/metrics-guide.md](https://github.com/render-oss/skills/blob/main/skills/render-monitor/references/metrics-guide.md)
